...
"""
on remarque que le traitement effectué genère des Nan pour le 1er match de chaque équipes dans les colonnes de la liste 
L_col. Comme cela représente x% du dataframe, on va supprimer ces lignes. 
160 / 18007 * 100 = 0.89%
"""

L_col = ["Hforme", "Hatt", "Hdef", "Hatt_sais", "Hdef_sais",
         "Aforme", "Aatt", "Adef", "Aatt_sais", "Adef_sais",
         "Hprecision", "Aprecision", "Hprec_weight", "Aprec_weight"]
