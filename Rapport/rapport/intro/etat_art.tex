...
L'un des premiers résultats majeurs dans ce domaine est initié par 
M. J. Maher \cite{maher}, lorsqu'il expose le fait que les buts marqués lors de rencontres 
...
les petits scores $x$-$y$ avec $x,y \in \left\{ 0,1 \right\} $. En effet, l'hypothèse d'indépendance 
des buts initiée par Maher est relaxée par Dixon et Coles pour les faibles scores mais conservée pour 
les scores plus importants. Ils ajoutent également une fonction $\phi$ pondérant les matchs récent.
