...
d'un facteur multiplicatif $\tau$ pour corriger la dépendance des faibles 
...
L'utilisation de la loi de Poisson repose sur l'hypothèse que la possession 
du ballon se transforme 
...
\noindent Les conditions du premier ordre donnent :
\[
...
\noindent Ce système peut être résolu par Newton-Raphson, ce qui conduit à l'approximation :
\[
