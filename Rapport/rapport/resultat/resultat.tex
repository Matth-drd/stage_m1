...
profits nous avons mis en place une mise dynamique. En fonction du seuil de confiance, ie la 
...
\noindent La figure \ref{fig:cdd_ml_stat_logloss} permet de classer les modèles entre eux 
mais également par rapport au bookmaker Bwin en utilisant la métrique de log loss. La figure \ref{fig:cdd_ml_stat_brier} 
compare le Brier score. \\
Les "crossbar" regroupent les modèles 
