...
La première approche abordée par la littérature est l'approche statistique. 
Nous avons donc naturellement implémenté un modèle se basant sur la loi de 
Poisson. Dans un premier, nous nous sommes concentré sur la version de Maher, 
puis nous avons appliqués les modifications de Dixon et Coles. 

\section{Modèle de Poisson -- Maher (1982)}

L'utili de la loi de Poisson repose sur l'hypothèse que la possession du ballon se transforme 
...
Dans la continuité du modèle de Maher, Dixon et Coles ont appliqué un coefficient $\gamma$ représentant 
l'avantage de jouer à domicile, ainsi qu'une fonction $\tau$ pour gérer 
