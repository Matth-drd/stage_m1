...
\begin{longtable}{lllp{5.5cm}}
    ...
    Efficacité pond.  & \texttt{FT\_Hprec\_weight} & \texttt{FT\_Aprec\_weight} & Précision pondérée ($w_g = 12$) \\
...
\begin{figure}[H]
    ...
    \label{fig:cdd}
\end{figure}
\noindent Sur la figure \ref{fig:cdd} le trait noir reliant de couleur signifi, qu'il n'y a pas de différence 
significative entre les deux bookmakers. 
