...
L'Erreur Quadratique Moyenne ($MSE = \frac{1}{n} \sum(y - \hat{y})^2$) 
mesure la moyenne des carrés des écarts entre les valeurs prédites et les valeurs réelles. 
...
\section{Mean\_poisson\_deviance}
